...
valgrind --leak-check=full ./mapper commandFile1.txt 10&
sleep 1
valgrind --leak-check=full ./reducer student_out1.txt 1
sleep 3
...
valgrind --leak-check=full ./mapper commandFile2.txt 10&
sleep 1
valgrind --leak-check=full ./reducer student_out2.txt 1
sleep 3
...
valgrind --leak-check=full ./mapper commandFile3.txt 10&
sleep 1
valgrind --leak-check=full ./reducer student_out3.txt 1
sleep 3
...
valgrind --leak-check=full ./mapper commandFile1.txt 10&
sleep 1
valgrind --leak-check=full ./reducer student_out4.txt 3
sleep 3
...
valgrind --leak-check=full ./mapper commandFile2.txt 10&
sleep 1
valgrind --leak-check=full ./reducer student_out5.txt 3
sleep 3
...
valgrind --leak-check=full ./mapper commandFile3.txt 10&
sleep 1
valgrind --leak-check=full ./reducer student_out6.txt 3
sleep 3
